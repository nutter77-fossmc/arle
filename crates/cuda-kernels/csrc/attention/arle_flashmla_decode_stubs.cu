...
// Note: arle_flashmla_csa_build_indices / hca_build_indices / fill_pad_rows
// live in csrc/misc/arle_flashmla_csa_prep.cu, which has no SM90-specific
// dependencies and compiles fine on SM89. Don't stub them here — that
// would duplicate the symbols. Only the SM90 sparse-decode shim is gated.
