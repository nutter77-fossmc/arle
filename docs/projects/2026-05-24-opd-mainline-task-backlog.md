...
| T18 | **OPD recipe variant** — lr=1e-5 or LR-decay-from-step-1000, save every 250 | codex | **completed / PARTIAL** (`a83f2c2` launch, `b0ec925` chart, `d858755` result) | lr=1e-5 run stopped cleanly at step 3288 after heldout KL plateau. Capability sweep early-gated on step_001000 and step_002500: step_001000 beat P5 MMLU winner (`50.59% > 50.00%`), but no row beat base (`51.41%`) and the heldout-KL best step_002500 fell to `46.11%` MMLU. README not updated; result entry keeps the ARLE-vs-TRL perf framing and closes "lower LR fixes capability" as not headline-ready. | [wins/2026-05-25-t18-recipe-variant-result.md](../experience/wins/2026-05-25-t18-recipe-variant-result.md) |
| T19 | **Stale doc + dead code cleanup pass** ("删除陈旧的文档和无用的代码 需要的时候再加") | codex | **completed** (`ccc9a86`, `196919d`, final wins/backlog commit) | Conservative SAFE_DELETE/EDIT_NOT_DELETE pass: pruned retired `arle train test` fixture, updated stale OPD-pivot train-surface claims, confirmed no old bench-output cutoff candidates, and recorded CUDA-feature clippy / archived link repairs as NEEDS_CKL_REVIEW instead of over-deleting. | [wins/2026-05-25-stale-doc-dead-code-cleanup.md](../experience/wins/2026-05-25-stale-doc-dead-code-cleanup.md) |
...
| T18 OPD recipe variant (`a83f2c2`, `b0ec925`, `d858755`) | [P5 capability sweep](../experience/wins/2026-05-25-p5-pure-opd-5k-capability-sweep.md), [ARLE vs TRL](../experience/wins/2026-05-21-arle-vs-trl-gkd-head-to-head.md) | [wins/2026-05-25-t18-recipe-variant-result.md](../experience/wins/2026-05-25-t18-recipe-variant-result.md), [chart](img/2026-05-25-t18-vs-p5-heldout-and-capability.png) |
| T19 stale doc + dead code cleanup (`ccc9a86`, `196919d`) | This backlog; [quick cleanup pass](../experience/wins/2026-05-25-stale-doc-quick-cleanup-pass.md) | [wins/2026-05-25-stale-doc-dead-code-cleanup.md](../experience/wins/2026-05-25-stale-doc-dead-code-cleanup.md) |
