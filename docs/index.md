...
Last refreshed: 2026-05-09 EOD+141 (**🎉 P1.2 W4A8 Marlin scratch hoist LANDED `ca0673b`** TTFT p50 1638.8ms vs W4A16 -31.3% / **ITL p50 11.41ms vs P1.0 hybrid -13.0%**(P1.0 ITL tradeoff RESOLVED via graph capture)/ out tok/s 224.95 vs W4A16 +17.5%;**🎉 P1.0 hybrid W4A8 prefill LANDED `9773904`** TTFT -31.5% env-gated `INFER_HYBRID_W4A8_PREFILL=1`;**P0.0 Phase 1.A nvtx decomp `aaf0b55`** prefill 97% dominant axis-evidence-locked; **P0.2 Hybrid Phase 1b loader LANDED `232aed5`**;**B3 Step 2 PrefixAwareAdmission LANDED `b85929b`** -24.2% TTFT;R4 #6 W4A16BatchGemv override KILLED `3b9cc06` (+37% ITL regression empirical KILL);W4A8 GPTQ-zpfix LANDED `2a3a6f0`;cap=8 default `12300c5` (real fix per 7-layer audit `3fea979`);skill v1.8.0 LANDED `6ab2293` 25 anti-patterns;ops-layer optimization roadmap `2e21da1`(P1.3 quantized fused_mlp next prefill-aligned axis dispatched 16:42);210+ commits since 2026-05-08 EOD). Priority order canonical in [`ROADMAP.md` §Next-Model Priority Order](../ROADMAP.md#next-model-priority-order). Anchor doc for resumption: [`docs/research/2026-05-08-eod67-final-state-anchor.md`](research/2026-05-08-eod67-final-state-anchor.md). Pickup queue: [`docs/plans/codex-pickup-queue-2026-05-09.md`](plans/codex-pickup-queue-2026-05-09.md)(P1.2 LANDED → **P1.3 quantized fused_mlp dispatched** `/tmp/codex-brief-p1.3-quant-fused-mlp.txt` 255-line directive,prefill-aligned highest per nsys 97%).
